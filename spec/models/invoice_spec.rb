...
# Unit tests for SematextCloud::Invoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Invoice' do
  before do
    # run before each test
    @instance = SematextCloud::Invoice.new
  end
  ...
  describe 'test an instance of Invoice' do
    it 'should create an instance of Invoice' do
      expect(@instance).to be_instance_of(SematextCloud::Invoice)
    end
  end
  describe 'test attribute "all_charges"' do
    it 'should work' do
