...
# Unit tests for SematextCloud::BasicAuthMethodDto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BasicAuthMethodDto' do
  before do
    # run before each test
    @instance = SematextCloud::BasicAuthMethodDto.new
  end
  ...
  describe 'test an instance of BasicAuthMethodDto' do
    it 'should create an instance of BasicAuthMethodDto' do
      expect(@instance).to be_instance_of(SematextCloud::BasicAuthMethodDto)
    end
  end
