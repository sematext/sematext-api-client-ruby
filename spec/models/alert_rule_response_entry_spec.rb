...
# Unit tests for stcloud::AlertRuleResponseEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AlertRuleResponseEntry' do
  before do
    # run before each test
    @instance = stcloud::AlertRuleResponseEntry.new
  end
  ...
  describe 'test an instance of AlertRuleResponseEntry' do
    it 'should create an instance of AlertRuleResponseEntry' do
      expect(@instance).to be_instance_of(stcloud::AlertRuleResponseEntry)
    end
  end
