...
# Unit tests for SematextCloud::TokensResponseEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TokensResponseEntry' do
  before do
    # run before each test
    @instance = SematextCloud::TokensResponseEntry.new
  end
  ...
  describe 'test an instance of TokensResponseEntry' do
    it 'should create an instance of TokensResponseEntry' do
      expect(@instance).to be_instance_of(SematextCloud::TokensResponseEntry)
    end
  end
