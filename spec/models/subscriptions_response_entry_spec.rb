...
# Unit tests for SematextCloud::SubscriptionsResponseEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SubscriptionsResponseEntry' do
  before do
    # run before each test
    @instance = SematextCloud::SubscriptionsResponseEntry.new
  end
  ...
  describe 'test an instance of SubscriptionsResponseEntry' do
    it 'should create an instance of SubscriptionsResponseEntry' do
      expect(@instance).to be_instance_of(SematextCloud::SubscriptionsResponseEntry)
    end
  end
