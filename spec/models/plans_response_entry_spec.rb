...
# Unit tests for SematextCloud::PlansResponseEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PlansResponseEntry' do
  before do
    # run before each test
    @instance = SematextCloud::PlansResponseEntry.new
  end
  ...
  describe 'test an instance of PlansResponseEntry' do
    it 'should create an instance of PlansResponseEntry' do
      expect(@instance).to be_instance_of(SematextCloud::PlansResponseEntry)
    end
  end
