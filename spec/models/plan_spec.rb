...
describe 'Plan' do
  ...
  describe 'test attribute "plan_scheme"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SPM_1_0", "SPM_2_0", "SEARCHENE_1_0", "LOGSENE_1_0", "LOGSENE_2_0", "RUM_1_0", "RUM_1_1", "RUM_EA", "SYNTHETICS_EA", "SYNTHETICS_1_0"])
