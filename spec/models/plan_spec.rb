...
# Unit tests for SematextCloud::Plan
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Plan' do
  before do
    # run before each test
    @instance = SematextCloud::Plan.new
  end
  ...
  describe 'test an instance of Plan' do
    it 'should create an instance of Plan' do
      expect(@instance).to be_instance_of(SematextCloud::Plan)
    end
  end
  ...
  describe 'test attribute "plan_scheme"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SPM_1_0", "SPM_2_0", "SEARCHENE_1_0", "LOGSENE_1_0", "LOGSENE_2_0", "RUM_1_0", "RUM_1_1", "RUM_EA", "SYNTHETICS_EA", "SYNTHETICS_1_0", "BUGZ_EA"])
