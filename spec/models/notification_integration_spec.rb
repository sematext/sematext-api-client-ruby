...
# Unit tests for SematextCloud::NotificationIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'NotificationIntegration' do
  before do
    # run before each test
    @instance = SematextCloud::NotificationIntegration.new
  end
  ...
  describe 'test an instance of NotificationIntegration' do
    it 'should create an instance of NotificationIntegration' do
      expect(@instance).to be_instance_of(SematextCloud::NotificationIntegration)
    end
  end
