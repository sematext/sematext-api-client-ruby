...
# Unit tests for SematextCloud::UpdatePlanResponseDto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdatePlanResponseDto' do
  before do
    # run before each test
    @instance = SematextCloud::UpdatePlanResponseDto.new
  end
  ...
  describe 'test an instance of UpdatePlanResponseDto' do
    it 'should create an instance of UpdatePlanResponseDto' do
      expect(@instance).to be_instance_of(SematextCloud::UpdatePlanResponseDto)
    end
  end
