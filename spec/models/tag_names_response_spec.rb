...
# Unit tests for SematextCloud::TagNamesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TagNamesResponse' do
  before do
    # run before each test
    @instance = SematextCloud::TagNamesResponse.new
  end
  ...
  describe 'test an instance of TagNamesResponse' do
    it 'should create an instance of TagNamesResponse' do
      expect(@instance).to be_instance_of(SematextCloud::TagNamesResponse)
    end
  end
