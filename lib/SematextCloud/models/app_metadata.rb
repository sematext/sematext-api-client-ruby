...
module SematextCloud
  class AppMetadata
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'awsCloudWatchAccessKey')
        self.aws_cloud_watch_access_key = attributes[:'awsCloudWatchAccessKey']
      end

      if attributes.has_key?(:'awsCloudWatchSecretKey')
        self.aws_cloud_watch_secret_key = attributes[:'awsCloudWatchSecretKey']
      end

      if attributes.has_key?(:'awsFetchFrequency')
        self.aws_fetch_frequency = attributes[:'awsFetchFrequency']
      end
    ...
    def valid?
      aws_fetch_frequency_validator = EnumAttributeValidator.new('String', ['MINUTE', 'FIVE_MINUTES', 'FIFTEEN_MINUTES'])
      return false unless aws_fetch_frequency_validator.valid?(@aws_fetch_frequency)
      aws_region_validator = EnumAttributeValidator.new('String', ['US_EAST_1', 'US_WEST_1', 'EU_WEST_1', 'US_WEST_2', 'AP_SOUTHEAST_1', 'AP_SOUTHEAST_2', 'AP_NORTHEAST_1', 'SA_EAST_1', 'GovCloud', 'CN_NORTH_1', 'US_EAST_2', 'AP_SOUTH_1', 'AP_NORTHEAST_2', 'CA_CENTRAL_1', 'EU_CENTRAL_1', 'EU_WEST_2'])
