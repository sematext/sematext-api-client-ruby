...
module stcloud
  class UserRole
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'roleStatus')
        self.role_status = attributes[:'roleStatus']
      end
    ...
    def valid?
      role_validator = EnumAttributeValidator.new('String', ['SUPER_USER', 'OWNER', 'ADMIN', 'USER', 'DEMO', 'ANONYMOUS'])
      return false unless role_validator.valid?(@role)
      role_status_validator = EnumAttributeValidator.new('String', ['INACTIVE', 'ACTIVE'])
