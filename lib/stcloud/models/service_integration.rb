...
module stcloud
  class ServiceIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'appTypeName')
        self.app_type_name = attributes[:'appTypeName']
      end
      ...
      if attributes.has_key?(:'externalProductId')
        self.external_product_id = attributes[:'externalProductId']
      end

      if attributes.has_key?(:'externalProductName')
        self.external_product_name = attributes[:'externalProductName']
      end
      ...
      if attributes.has_key?(:'parentIntegrationId')
        self.parent_integration_id = attributes[:'parentIntegrationId']
      end
